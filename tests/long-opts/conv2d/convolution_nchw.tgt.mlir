func.func @conv(%input: tensor<1x3x225x225xf32>, %filter: tensor<32x3x3x3xf32>,
  ...
  %0 = bufferization.to_memref %input : tensor<1x3x225x225xf32> to memref<1x3x225x225xf32>
  %1 = bufferization.to_memref %filter : tensor<32x3x3x3xf32> to memref<32x3x3x3xf32>
  %2 = bufferization.to_memref %output : tensor<1x32x112x112xf32> to memref<1x32x112x112xf32>
  ...
  %4 = bufferization.to_tensor %3 : memref<1x32x112x112xf32> to tensor<1x32x112x112xf32>
