...
func.func @fold_subview(%arg0: tensor<64x64xf32>, %off_y: index, %off_x: index, %dim_y: index, %dim_x: index, %idx_y: index, %idx_x: index) -> f32 {
    %0 = bufferization.to_memref %arg0 : memref<64x64xf32>
