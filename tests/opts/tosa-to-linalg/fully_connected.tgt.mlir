...
module  {
  func @f(%arg0: tensor<10x3xf32>, %arg1: tensor<6x3xf32>, %arg2: tensor<6xf32>) -> tensor<10x6xf32> {
    %0 = linalg.init_tensor [10, 6] : tensor<10x6xf32>
    %cst = arith.constant 0.000000e+00 : f32
    %1 = linalg.fill(%cst, %0): f32, tensor<10x6xf32> -> tensor<10x6xf32> 
