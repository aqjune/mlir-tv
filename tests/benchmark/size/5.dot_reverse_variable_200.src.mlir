...
func @f(%a: tensor<100xf32>, %b: tensor<100xf32>) -> tensor<f32> {
  ...
  %ra = "tosa.reverse"(%a) {axis = 0 : i64} : (tensor<100xf32>) -> tensor<100xf32>
  %rb = "tosa.reverse"(%b) {axis = 0 : i64} : (tensor<100xf32>) -> tensor<100xf32>
  %res = linalg.dot ins(%ra, %rb : tensor<100xf32>, tensor<100xf32>)
