...
func @f(%a: tensor<10xf32>, %b: tensor<10xf32>) -> tensor<f32> {
  ...
  %ra = "tosa.reverse"(%a) {axis = 0 : i64} : (tensor<10xf32>) -> tensor<10xf32>
  %rb = "tosa.reverse"(%b) {axis = 0 : i64} : (tensor<10xf32>) -> tensor<10xf32>
  %res = linalg.dot ins(%ra, %rb : tensor<10xf32>, tensor<10xf32>)
