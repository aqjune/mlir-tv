...
func @avgpool(%arg0: tensor<1x7x7x1280xf32>) -> tensor<1x1x1x1280xf32> {
  ...
  %3 = linalg.pooling_nhwc_sum {dilations = dense<1> : vector<2xi64>, strides = dense<1> : vector<2xi64>} ins(%arg0, %2 : tensor<1x7x7x1280xf32>, tensor<7x7xf32>) outs(%1 : tensor<1x1x1x1280xf32>) -> tensor<1x1x1x1280xf32>
