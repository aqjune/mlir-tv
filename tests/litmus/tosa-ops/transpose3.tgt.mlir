func @conv(%arg0: tensor<1x16x16x4xf32>, %arg1: tensor<3x3x4x16xf32>) -> tensor<1x14x14x16xf32> {
    ...
    %arg3 = "tosa.transpose"(%arg0, %inperms) : (tensor<1x16x16x4xf32>, tensor<4xi64>) -> tensor<1x4x16x16xf32>
    %arg4 = "tosa.transpose"(%arg1, %filperms) : (tensor<3x3x4x16xf32>, tensor<4xi64>) -> tensor<16x4x3x3xf32>
    ...
    %1 = "tosa.transpose"(%0, %outperms) : (tensor<1x16x14x14xf32>, tensor<4xi64>) -> tensor<1x14x14x16xf32>
