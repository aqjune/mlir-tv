...
module  {
  func @conv(%arg0: tensor<1x3x3x2xf32>, %arg1: tensor<1x3x3x2xf32>) -> tensor<1x1x1x1xf32> {
    %cst = arith.constant 0.000000e+00 : f32
    %0 = tensor.from_elements %cst : tensor<1xf32>
    %cst_0 = arith.constant dense<[1, 2, 3, 0]> : tensor<4xi64>
    %1 = linalg.init_tensor [3, 3, 2, 1] : tensor<3x3x2x1xf32>
    %2 = linalg.generic {indexing_maps = [#map0, #map1], iterator_types = ["parallel", "parallel", "parallel", "parallel"]} ins(%arg1 : tensor<1x3x3x2xf32>) outs(%1 : tensor<3x3x2x1xf32>) {
    ...
    %6 = linalg.conv_2d_nhwc_hwcf {dilations = dense<1> : tensor<2xi64>, strides = dense<1> : tensor<2xi64>} ins(%arg0, %2 : tensor<1x3x3x2xf32>, tensor<3x3x2x1xf32>) outs(%4 : tensor<1x1x1x1xf32>) -> tensor<1x1x1x1xf32>
