func.func @depthwise_conv(%arg0 : tensor<2x7x5x3xf32>, %arg1 : tensor<3x1x3x2xf32>, %arg2 : tensor<6xf32>) -> tensor<2x5x5x2xf32> {
  ...
  %in2 = tensor.expand_shape %in [[0],[1],[2,3]] output_shape [2,7,5,1] : tensor<2x7x5xf32> into tensor<2x7x5x1xf32>
  %fil2 = tensor.expand_shape %fil [[0,1],[2,3]] output_shape [3,1,1,2] : tensor<3x2xf32> into tensor<3x1x1x2xf32>
  ...
  %fil3 = "tosa.transpose"(%fil2, %filperms) : (tensor<3x1x1x2xf32>, tensor<4xi32>) -> tensor<2x3x1x1xf32>
