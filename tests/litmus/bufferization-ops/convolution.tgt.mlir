func.func @conv(%input: tensor<1x225x225x3xf32>, %filter: tensor<3x3x3x32xf32>,
  ...
  %0 = bufferization.to_memref %input : tensor<1x225x225x3xf32> to memref<1x225x225x3xf32>
  %1 = bufferization.to_memref %filter : tensor<3x3x3x32xf32> to memref<3x3x3x32xf32>
  %2 = bufferization.to_memref %output : tensor<1x112x112x32xf32> to memref<1x112x112x32xf32>
  ...
  %4 = bufferization.to_tensor %3 : memref<1x112x112x32xf32> to tensor<1x112x112x32xf32>
